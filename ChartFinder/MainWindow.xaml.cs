...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        if (_songHandler.Songs.Count > 0)
        {
            StatusText.Text = $"Loaded {_songHandler.Songs.Count} songs from cache...";
        }
        OutputGrid.ItemsSource = _songHandler.Songs;
    ...
    private async void run_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (songsFound)
        {
            Dispatcher.Invoke(() =>
            {
                StatusText.Text = $"Song loading complete. Found {_songHandler.Songs.Count} songs.";
            });
        }
        else
        {
            StatusText.Text = "No songs with BRE or Lanes found...";
        }

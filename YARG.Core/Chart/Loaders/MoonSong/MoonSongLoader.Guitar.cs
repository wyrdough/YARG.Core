...
namespace YARG.Core.Chart
{
    internal partial class MoonSongLoader : ISongLoader
    {
        ...
        private InstrumentTrack<GuitarNote> LoadGuitarTrack(Instrument instrument, CreateNoteDelegate<GuitarNote> createNote)
        {
            ...
            {
                { Difficulty.Beginner, LoadDifficulty(instrument, Difficulty.Beginner, CreateFiveFretBeginnerNote) },
            ...
            Dictionary<MoonPhrase.Type, MoonPhrase> currentPhrases)
        {
            ...
            return new GuitarNote(fret, noteType, guitarFlags, generalFlags, time, 0.0001, moonNote.tick, 1);
        }
